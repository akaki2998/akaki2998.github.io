...
$(document).ready(function () {
    ...
    let competitionListing = {
        'dayFirst': ['50 გულაღმა', '800 თავისუფალი', '100 თავისუფალი', '200 ბრასი', '200 ბატერფლაი', '400 კომპლექსი'],
        'daySecond': ['50 ბრასი', '100 ბატერფლაი', '200 თავისუფალი', '200 გულაღმა', '1500 თავისუფალი'],
        'dayThird': ['50 თავისუფალი', '50 ბატერფლაი', '100 ბრასი', '100 გულაღმა', '400 თავისუფალი', '200 კომპლექსი'],
    }
                ...
                for (j = 0; j < eventsArray.length; j++) {
                    if (competitionListing.dayFirst[i] == eventsArray[j].event) {
                        ...
                        if (heatNameAndSwimmers.name != ' ') {
                            ...
                            $('#firstDay').append('<div class="swimmersData"><nav></nav><nav>სახელი</nav><nav>კლუბი</nav><nav>დაბ.წელი</nav><nav>წინასწარი შედეგი</nav><nav>შეჯიბრი</nav><nav>თარიღი</nav></div><hr>')
                ...
                for (j = 0; j < eventsArray.length; j++) {
                    if (competitionListing.daySecond[i] == eventsArray[j].event) {
                        ...
                        if (heatNameAndSwimmers.name != ' ') {
                            ...
                            heatNameAndSwimmers.swimmers[0].gender == 'კაცი' ? satauri = 'კაცები' : satauri = 'ქალები';
                            $('#thirdDay').append('<div class="eventsHeader2">' + 'ივენთი# ' + countEventsStartlist + '</div></br>')
                ...
                for (j = 0; j < eventsArray.length; j++) {
                    if (competitionListing.dayFirst[i] == eventsArray[j].event) {
                        ...
                        if (heatNameAndSwimmers2.name != ' ') {
                            ...
                            let reverseCount = parseInt(heatNameAndSwimmers2.swimmers.length / lanesQuantityInPool) + 1;
                            //აქ ითვლი რმდენი გაცურვა შედგება
                            for (g = 0; g < (parseInt(heatNameAndSwimmers2.swimmers.length / lanesQuantityInPool)) + 1; g++) {
                                convertedArray.push({ 'heat': 'გაცურვა' + ' ' +  reverseCount, 'swimmers': [] })
                ...
                for (j = 0; j < eventsArray.length; j++) {
                    if (competitionListing.dayThird[i] == eventsArray[j].event) {
                        ...
                        for (p = 0; p < eventsArray[j].swimmer.length; p++) {
                            ...
                            convertedSeconds2 = parseInt((eventsArray[j].swimmer[p][5].split('.')[0]) * 60) + parseInt(eventsArray[j].swimmer[p][5].split('.')[1].split(':')[0]) + ((eventsArray[j].swimmer[p][5].split('.')[1].split(':')[1]) / 100);
                            //აქ იქმნება არრეები სადაც დალაგებულია გაცურვების
                            heatNameAndSwimmers2.name = competitionListing.dayThird[i];
                            heatNameAndSwimmers2.swimmers.push({ 'name': eventsArray[j].swimmer[p][0], 'age': eventsArray[j].swimmer[p][1], 'club': eventsArray[j].swimmer[p][2], 'event': eventsArray[j].swimmer[p][3], 'gender': eventsArray[j].swimmer[p][4], 'time': eventsArray[j].swimmer[p][5], 'location': eventsArray[j].swimmer[p][6], 'date': eventsArray[j].swimmer[p][7], 'seconds': convertedSeconds2 })
                        }
                        ...
                        if (heatNameAndSwimmers2.name != ' ') {
                            ...
                            $('#thirdDayHeats').append('<div class="eventsHeader21">ივენთი# ' + countEvents + '</div></br>')
                            $('#thirdDayHeats').append('<div class="eventsHeader2">' + satauri1 + ' ' + satauri2 + '</div></br>')
                            for (o = convertedArray.length - 1; o > -1; o--) {
                                $('#thirdDayHeats').append('<div class="heatNumber">' + convertedArray[o].heat + '</div>')
                                $('#thirdDayHeats').append('<div class="swimmersData2Header"><nav></nav><nav>სახელი</nav><nav>კლუბი</nav><nav>დაბ.წელი</nav><nav>წინასწარი შედეგი</nav>')
                                ...
                                for(l=0;l<convertedArray[o].swimmers.length;l++) {
                                     $('#thirdDayHeats').append('<div class="swimmersData2"><nav></nav><nav>' + 'ბილიკი ' + convertedArray[o].swimmers[l].que + '.</nav><nav>' + convertedArray[o].swimmers[l].swimmerName + '</nav><nav>' + convertedArray[o].swimmers[l].club + '</nav><nav>' + convertedArray[o].swimmers[l].age + '</nav><nav>' + convertedArray[o].swimmers[l].preResult + '</nav>')
                                }
                               
                                $('#thirdDayHeats').append('</br></br>')
                            }
                            $('#thirdDayHeats').append('</br></br></br></br></br>')
                            convertedArray = [];
                        }
...
for(i=0;i<competitionListing.dayThird.length;i++) {
    $('#thirdDayProgram').append('<div>' + competitionListing.dayThird[i] +'</div>')
}
oneShot = 1;
}
